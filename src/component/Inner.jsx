...
//   useEffect(() => {
//     // Step 1: Animate to the small horizontal rectangle
//     contentControls.set({ scaleX: 0.2, scaleY: 0.01 }); // set immediately without animation

//     // Step 2: Then animate the overlay height down after a short delay
//     const timeout1 = setTimeout(() => {
//       overlayControls.start({
//         height: "0%",
//         transition: {
...
//           setShowSidebar(true);
//         }, 1000);
//       }, 1000); // wait for overlay animation

//       return () => clearTimeout(timeout2);
//     }, 500); // slight delay before overlay starts
...
//       <motion.div
//         className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full flex items-center justify-center"
//         initial={{ scaleX: 0.2, scaleY: 0.1 }} // Initial rectangle shape
//         animate={contentControls}
//         style={{ transformOrigin: "center" }}
//       >
//         {/* White overlay */}
