...
//       }  max-md:w-full text-white font-['Gothic'] text-3xl max-md:text-2xl flex justify-between items-end px-[2%] top-0 left-0 z-[10] tracking-wider leading-none transition-all duration-500 ease-in-out
//         ${
//           shouldShowNavbar
