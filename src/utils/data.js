...
const Descriptiondata = [
  {
    ...
    des: [
      "In the crime-infested Khansaar, Prince Varadha sets to",
      "ascend the throne. But a coup d'état is planned! And there's",
  ...
  },
  {
    ...
    des: [
      "Back from the brink of death, commando Tyler Rake",
      "embarks on a dangerous mission to save a ruthless",
  ...
  },
  {
    ...
    des: [
      "At Chetukwadi, Bittu unfurls the horrors of a vengeful spirit.",
      "Reawakened and eager to marry, Munjya follows him like a",
...

  {
    ...
    des: [
      ...
      "supernatural forces and secret government exploits.",
      " As they search for answers, the children unravel ",
  ...
  },
  {
    ...
    des: [
      ...
      "Campbell, an inspector, decides to nab him and put an end",
...

  {
    ...
    Category: "Drama | Thriller | Crime",
    des: [
      "During a visit to his motherland, a Korean-Italian mafia",
      "lawyer gives a conglomerate a taste of its own medicine",
  ...
  },
  {
    ...
    des: [
      ...
      "scare away her friend's prospective suitor. However, plans",
      "go awry when he turns out to be Ha-ri's CEO and he makes",
      "a proposal.",
    ],
    sliderdata: [
